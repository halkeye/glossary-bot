...
class TestBotSearch:
    ...
    def test_search_results(self, handle_glossary):
        ...
        matches = [
            (
                "CalWIN",
                "CalWORKs Information Network, a service supporting the administration of public assistance programs in a consortium of California counties, including CalFresh, Medi-Cal, General Assistance, and Foster Care. Part of SAWS.",
            ),
            (
                "TAY",
                "Transitional Age Youth, people between the ages of sixteen and twenty-four who are in transition from state custody or foster care and are at-risk.",
            ),
            (
                "SAWS",
                "the Statewide Automated Welfare System, made up of multiple systems (including C-IV, CalWin and LEADER) which support eligibility and benefit determination, enrollment, and case maintenance at the county level for some of California's major health and human services programs.",
            ),
            (
                "WIB",
                "Workforce Investment Board, a regional entity created to implement the Workforce Investment Act of 1998 by directing federal, state and local funding to workforce development programs.",
            ),
            (
                "ACYF",
